<div class="container-fluid bg-secondary text-dark mt-5 pt-5">
        <div class="row px-xl-5 pt-5" style="margin-top: -60px;">
            ...
            <div class="col-lg-7 col-md-12">
                <div class="row">
                    ...
                    <div class="col-md-4 mb-5">
                        ...
                        <div class="g-ytsubscribe" data-channelid="UCKK8ZFf3S-IshwmYmes6pyQ" data-layout="full" data-count="default"></div>
                    </div>
                </div>
            </div>
        </div>
        <div class="row border-top border-light mx-xl-5 py-4">
            <div class="col-md-6 px-xl-0">
                <p class="mb-md-0 text-center text-md-left text-dark">
                    &copy; <a class="text-dark font-weight-semi-bold" href="#">Someone</a>. All Rights Reserved. Designed
                    by Someone Official
                </p>
            </div>
